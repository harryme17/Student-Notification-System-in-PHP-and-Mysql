...
<body>
    <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="welcome3.php">Back</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container text-left d-grid gap-2 col-6 mx-auto custom-container">
        <h3>Please Register Staff Here:</h3>
        <hr>
        <form action="" method="post">
            ...
            <a href="welcome3.php" type="button" class="btn btn-secondary">Back</a>
        </form>
    </div>
